          ...
          <div class="d-flex justify-start align-center">
            <div>
              <v-avatar size="40" class="pb-0">
                <v-img :src="ui.imgURL || require('../../assets/images/rilievo.png')"></v-img>
              </v-avatar>
            </div>
            <div class="pl-1">
            ...
            <v-menu transition="slide-y-transition">
              ...
              <v-list>
                <v-list-item @click="openEditForm">
                  <v-list-item-title><v-icon class="pr-2">mdi-pencil</v-icon>Modifica</v-list-item-title>
                </v-list-item>
                <v-list-item>
                  <v-list-item-title><v-icon class="pr-2">mdi-email-sync-outline</v-icon>Invia</v-list-item-title>
                </v-list-item>
              </v-list>
            </v-menu>
          </v-col>
        ...
        <div v-if="$vuetify.breakpoint.smAndUp">
          <v-row class="mx-2">
            ...
            <v-col class="align-self-center">
              ...
              <div class="subtitle-1 ellipseText">{{ record.utente }} - {{ record.dataCreazione | dmy }}</div>
            </v-col>
                ...
                <v-col cols="2" class="align-self-center">
                  <v-menu transition="slide-y-transition">
                    ...
                    <v-list>
                      ...
                      <v-list-item @click="inviaRilievo">
                        <v-list-item-title><v-icon class="pr-2">mdi-email-sync-outline</v-icon>Invia</v-list-item-title>
                      </v-list-item>
                    </v-list>
                  </v-menu>
